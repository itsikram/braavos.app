<section class="defi-video">
	<div class="defi-video__container">
		<div class="defi-video__thumbnail">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/connect/video-wrapper.png" alt="Video thumbnail">
		...
		<div class="defi-video__video-container" id="video-container" style="display: none;">
			...
			<iframe id="youtube-video"  width="950" height="535" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
		</div>
	</div>
</section>
...
<script>
    document.getElementById('play-video').addEventListener('click', function() {
        ...
        youtubeVideo.src = "https://www.youtube.com/embed/969Uw50lFHk?autoplay=1";
