<section class="connect-hero">
    <div class="connect-hero__container">
        <div class="connect-hero__left-wrapper">
            <div class="connect-hero__icon">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/connect/Plus.png" alt="">
            </div>
            <?php $connect_hero_title = get_sub_field('connect_hero_title') ?>
            <?php if ($connect_hero_title) : ?>
                <h1 class="connect-hero__title">
                    <?php echo $connect_hero_title ?>
                </h1>
            <?php endif; ?>
            <?php if ( have_rows('connect_hero_list') ) : ?>
                <ul class="connect-hero__list">
                    <?php while ( have_rows('connect_hero_list')) : the_row(); ?>
                        <li class="connect-hero__item">
                            <?php $connect_hero_item = get_sub_field('connect_hero_item') ?>
                            <?php if ($connect_hero_item) : ?>
                                <?php echo $connect_hero_item ?>
                            <?php endif; ?>
                        </li>
                    <?php endwhile; ?>
                </ul>
            ...
            <a href="<?php echo $download_link['url']; ?>" class="connect-hero__link">
                <span class="connect-hero__link-icon">
                ...
                <span class="connect-hero__link-text">
                     <?php echo $download_link['title']; ?>
                </span>
            </a>
	        <?php endif; ?>
        </div>
        <div class="connect-hero__right-wrapper">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/connect/hero.png" alt="">
        </div>
    </div>
</section>