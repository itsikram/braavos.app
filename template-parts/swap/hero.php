<section class="swap-hero">
	<div class="swap-hero__container">
		<div class="swap-hero__left-wrapper">
			<div class="swap-hero__icon-wrapper">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/swap/Plus.png" alt="">
			</div>
            <?php $swap_hero_title = get_sub_field('swap_hero_title'); ?>
            <?php if ($swap_hero_title) : ?>
                <h1 class="swap-hero__title">
                    <?php echo $swap_hero_title; ?>
                </h1>
            <?php endif; ?>
			<?php $swap_hero_description = get_sub_field('swap_hero_description'); ?>
			<?php if ($swap_hero_description) : ?>
                <p class="swap-hero__description">
                    <?php echo $swap_hero_description; ?>
                </p>
			<?php endif; ?>
            <?php if (have_rows('swap_hero_list')) : ?>
                <ul class="swap-hero__list">
                    <?php while (have_rows('swap_hero_list')) : the_row(); ?>
                        <?php $swap_hero_list_item = get_sub_field('swap_hero_list_item'); ?>
                        <?php if ($swap_hero_list_item) : ?>
                            <li class="swap-hero__item">
                                <?php echo $swap_hero_list_item; ?>
                            </li>
                        <?php endif; ?>
                    <?php endwhile; ?>
                </ul>
			...
			<?php if ( $download_link ) : ?>
                <a href="<?php echo $download_link['url']; ?>" class="swap-hero__link">
                    <span class="swap-hero__link-icon">
                    ...
                    <span class="swap-hero__link-text">
                        <?php echo $download_link['title']; ?>
                    </span>
                </a>
			<?php endif; ?>
		</div>
		<div class="swap-hero__right-wrapper" id="swap-hero__right-wrapper">
<!--			<img src="--><?php //echo get_template_directory_uri(); ?><!--/assets/images/swap/swap-hero.png" alt="">-->
		</div>
	</div>
</section>