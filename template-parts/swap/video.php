<section class="defi-video">
    <div class="defi-video__container">
        <div class="defi-video__thumbnail">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/swap/video-bg.jpg" alt="Video thumbnail">
...
<script>
    document.getElementById('play-video').addEventListener('click', function() {
        ...
        youtubeVideo.src = "https://www.youtube.com/embed/-ztNOgm4VL4?autoplay=1";
