	...
	<div class="stake-hero__container">
		<div class="stake-hero__left-wrapper">
			<div class="stake-hero__icon">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/stake/Plus.png" alt="">
			</div>
            <?php $stake_hero_title = get_sub_field('stake_hero_title'); ?>
            <?php if ('stake_hero_title') : ?>
			<h1 class="stake-hero__title">
                <?php echo $stake_hero_title; ?>
			</h1>
            <?php endif; ?>
            <?php if(have_rows('stake_hero_list')) : ?>
			<ul class="stake-hero__list">
                <?php while(have_rows('stake_hero_list')) : the_row(); ?>
				<li class="stake-hero__item">
                    <?php $stake_hero_item = get_sub_field('stake_hero_item'); ?>
                    <?php if ('stake_hero_item') : ?>
                    <?php echo $stake_hero_item; ?>
                    <?php endif; ?>
				</li>
				<?php endwhile; ?>
			</ul>
			...
			<a href="<?php echo $download_link['url']; ?>" class="stake-hero__link">
		...
		<div class="stake-hero__right-wrapper">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/stake/hero.png" alt="">
		</div>
	</div>
</section>