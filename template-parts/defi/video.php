<section class="defi-video">
	<div class="defi-video__container">
		<div class="defi-video__thumbnail">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/images/defi/video-wrapper.png" alt="Video thumbnail">
		...
		<div class="defi-video__video-container" id="video-container" style="display: none;">
			<iframe id="youtube-video" src="https://www.youtube.com/embed/-ztNOgm4VL4?autoplay=1"  frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
		</div>
	</div>
</section>
