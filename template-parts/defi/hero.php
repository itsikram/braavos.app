    ...
    <div class="defi-hero__container">
        <div class="defi-hero__left-wrapper">
            <div class="defi-hero__icon">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/defi/Plus.png"
                     alt="">
            </div>
			<?php $defi_hero_title = get_sub_field( 'defi_hero_title' ); ?>
			<?php if ( $defi_hero_title ) : ?>
                <h1 class="defi-hero__title">
					<?php echo $defi_hero_title; ?>
                </h1>
			<?php endif; ?>
			<?php if ( have_rows( 'defi_hero_list' ) ) : ?>
                <ul class="defi-hero__list">
					<?php while ( have_rows( 'defi_hero_list' ) ) : the_row(); ?>
						<?php $defi_hero_list_item
							= get_sub_field( 'defi_hero_list_item' ); ?>
						<?php if ( $defi_hero_list_item ) : ?>
                            <li class="defi-hero__item">
								<?php echo $defi_hero_list_item; ?>
                            </li>
						<?php endif; ?>
					<?php endwhile; ?>
                </ul>
			...
			<?php if ( $download_link ) : ?>
                <a href="<?php echo $download_link['url']; ?>"
                   class="defi-hero__link">
        ...
        <div class="defi-hero__right-wrapper">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/defi/hero.png"
                 alt="">
        </div>
    </div>
</section>