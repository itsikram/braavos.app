...
$opt_name = 'theme_option';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Pages', 'your-textdomain-here'),
		'id'               => 'page_data',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Home Page', 'your-textdomain-here'),
		'id'               => 'homepage',
		'subsection' => true,
		'fields' => array(
			array(
				'id' => 'home_hero_text',
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => 'The most advanced wallet on Starknet',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
			...
			array(
				'type' => 'media',
				'title' => 'Hero Grid Image One',
				'id' => 'home_hero_grid_image_one',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Grid Image Two',
				'id' => 'home_hero_grid_image_two',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Grid Image Three',
				'id' => 'home_hero_grid_image_three',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Grid Image Three',
			...
			array(
				'type' => 'media',
				'title' => 'Deposit Image',
				'id' => 'home_deposit_image',
			),
			array(
				'type' => 'media',
				'title' => 'Security Image',
				'id' => 'home_security_image',
			),
			array(
				'type' => 'media',
				'title' => 'Swap Image',
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Security Page', 'your-textdomain-here'),
		'id'               => 'security_page',
		'subsection' => true,
		'fields' => array(
			array(
				'id' => 'security_hero_text',
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => ' Protect your assets with best in crypto security',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
				'id' => 'security_hero_image',
			),
			array(
				'type' => 'media',
				'title' => 'Biometric Image',
				'id' => 'security_biometric_image',
			),
			array(
				'type' => 'media',
				'title' => 'Three factor Image',
				'id' => 'security_three_factor_image',
			),
			array(
				'type' => 'media',
				'title' => 'Support Image',
				'id' => 'security_support_image',
			),
			array(
				'type' => 'media',
				'title' => 'Detection Image',
				'id' => 'security_detection_image',
			),
		)
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Swap Page', 'your-textdomain-here'),
		'id'               => 'swap_page',
		'subsection' => true,
		'fields' => array(
			array(
			...
			array(
				...
				'id' => 'swap_video_placeholder',
			),

			array(
				'type' => 'media',
				'title' => 'Description Image One',
				'id' => 'swap_description_image',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image Two',
				'id' => 'swap_description_image_two',
			),
			array(
				'type' => 'media',
				'title' => 'Paid Image',
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Deposit Page', 'your-textdomain-here'),
		'id'               => 'deposit_page',
		'subsection' => true,
		'fields' => array(
			array(
				'id' => 'deposit_hero_text',
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => ' Deposit crypto using multiple options  ',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
				'id' => 'deposit_hero_image',
			),

			array(
				'type' => 'media',
				'title' => 'Video Placehoder Image',
				'id' => 'deposit_video_placehoder_image',
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Connect Page', 'your-textdomain-here'),
		'id'               => 'connect_page',
		'subsection' => true,
		'fields' => array(
			array(
				'id' => 'connect_hero_text',
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => 'Connect to any Starknet dApps in seconds',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
				'id' => 'connect_hero_image',
			),

			array(
				'type' => 'media',
				'title' => 'Video Placehoder Image',
				'id' => 'connect_video_placehoder_image',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image',
				'id' => 'connect_description_image',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image Mobile',
				'id' => 'connect_description_image_mobile',
			),

			array(
				'type' => 'media',
				'title' => 'Description Image two',
				'id' => 'connect_description_image_two',
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Stake Page', 'your-textdomain-here'),
		'id'               => 'stake_page',
		'subsection' => true,
		'fields' => array(
			array(
				...
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => 'Maximize your yield on your ETH with one click',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
			...
			array(
				...
				'id' => 'stake_hero_image_mobile',
			),

			array(
				'type' => 'media',
				'title' => 'Video Placehoder Image',
				'id' => 'stake_video_placehoder_image',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image',
				'id' => 'stake_description_image',
			),

			array(
				'type' => 'media',
				'title' => 'Description Image two',
				'id' => 'stake_description_image_two',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image two light',
				'id' => 'stake_description_image_two_light',
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Defi Page', 'your-textdomain-here'),
		'id'               => 'defi_page',
		'subsection' => true,
		'fields' => array(
			array(
				...
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => 'Monitor all your DeFi positions inside your wallet',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
			...
			array(
				'type' => 'media',
				'title' => 'Hero Image Mobile',
				'id' => 'defi_hero_image_mobile',
			),

			array(
				'type' => 'media',
				'title' => 'Video Placehoder Image',
				'id' => 'defi_video_placehoder_image',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image',
				'id' => 'defi_description_image',
			),
...
// One Click Invest PAGE
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('One Click Invest Page', 'your-textdomain-here'),
		'id'               => 'oci_page',
		'subsection' => true,
		'fields' => array(
			array(
				...
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => 'Maximize your yield <br> on your crypto with <br> one click',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
			...
			array(
				'type' => 'media',
				'title' => 'Video Placehoder Image',
				'id' => 'oci_video_placehoder_image',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image One',
				'id' => 'oci_description_image_one',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image two',
				'id' => 'oci_description_image_two',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image Three',
				'id' => 'oci_description_image_three',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image Four',
				'id' => 'oci_description_image_four',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image Four Mobile',
				'id' => 'oci_description_image_four_mobile',
			),
			array(
				'type' => 'media',
				'title' => 'Description Image Five',
				'id' => 'oci_description_image_five',
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Explore Page', 'your-textdomain-here'),
		'id'               => 'explore_page',
		'subsection' => true,
		'fields' => array(
			array(
				'id' => 'explore_hero_text',
				'type' => 'text',
                'title' => esc_html__('Hero Text', 'your-textdomain-here'),
				'default' => ' Explore Starknet <br> applications',
			),
			array(
				'type' => 'media',
				'title' => 'Hero Image',
				'id' => 'explore_hero_image',
			),

			array(
				'type' => 'media',
				'title' => 'Description Image',
				'id' => 'explore_description_image',
			),
